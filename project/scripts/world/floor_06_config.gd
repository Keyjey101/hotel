...
static func get_floor_06_rooms() -> Dictionary:
	...
	rooms["a2"] = RoomConfig._make({
		...
		"loot": [],
		"connections": ["a1", "hub"],
		"spawn_point_positions": RoomConfig._gen_spawn_points(Vector2i(8 * TILE, 4 * TILE), 8),
		"loot_zone_positions": [],
		"door_positions": RoomConfig._gen_doors(Vector2i(8 * TILE, 4 * TILE), ["a1", "hub"], ["top", "bottom"]),
		"branch": "a",
	})
	...
	rooms["b1"] = RoomConfig._make({
		...
		"loot_zone_positions": RoomConfig._gen_loot_zones(Vector2i(12 * TILE, 10 * TILE), 1),
		"door_positions": RoomConfig._gen_doors(Vector2i(12 * TILE, 10 * TILE), ["hub", "b2"], ["top", "bottom"]),
		"branch": "b",
	})
	...
	rooms["b2"] = RoomConfig._make({
		...
		"loot_zone_positions": RoomConfig._gen_loot_zones(Vector2i(6 * TILE, 6 * TILE), 2),
	...
	rooms["c1"] = RoomConfig._make({
		...
		"loot_zone_positions": RoomConfig._gen_loot_zones(Vector2i(12 * TILE, 8 * TILE), 2),
		"door_positions": RoomConfig._gen_doors(Vector2i(12 * TILE, 8 * TILE), ["hub", "c2"], ["left", "right"]),
		"branch": "c",
		"is_locked": true,
	})
	...
	rooms["boss"] = RoomConfig._make({
		...
		"connections": ["hub"],
		"spawn_point_positions": RoomConfig._gen_spawn_points(Vector2i(16 * TILE, 14 * TILE), 12),
		"loot_zone_positions": RoomConfig._gen_loot_zones(Vector2i(16 * TILE, 14 * TILE), 2),
		"door_positions": RoomConfig._gen_doors(Vector2i(16 * TILE, 14 * TILE), ["hub"], ["top"]),
		"branch": "boss",
	})
