...
## Ending C — "The Revelation" (Never attack Sister)

const BG_COLOR := Color(0.04, 0.04, 0.04)  # #0A0A0A void black
const TITLE_COLOR := Color(0.7, 0.7, 0.7)
const TITLE_TEXT := "THE TRUTH"
...
func _build_ui() -> void:
	...
	body.add_theme_color_override("font_color", Color(0.6, 0.6, 0.6))
