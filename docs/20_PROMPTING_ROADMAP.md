...
**Статус: ✅ ВЫПОЛНЕНО** — см. docs/21_CANONICAL_NUMBERS.md (single source of truth).
Правки внесены в 00_PILLAR_DOCUMENT.md и 01_GDD.md. Противоречия из раздела 1.1 выше устранены.
